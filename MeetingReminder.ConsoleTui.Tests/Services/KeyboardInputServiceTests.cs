...
public class KeyboardInputServiceTests
{
    ...
    public void UpArrow_ReturnsNavigateUp()
    {
        ...
        key.MapToInputCommand().Should().Be(InputCommand.NavigateUp);
    }
    ...
    public void DownArrow_ReturnsNavigateDown()
    {
        ...
        key.MapToInputCommand().Should().Be(InputCommand.NavigateDown);
    }
    ...
    public void Enter_ReturnsAcknowledge()
    {
        ...
        key.MapToInputCommand().Should().Be(InputCommand.Acknowledge);
    }
    ...
    public void OKey_ReturnsOpenAndAcknowledge()
    {
        ...
        key.MapToInputCommand().Should().Be(InputCommand.OpenAndAcknowledge);
    }
    ...
    public void CtrlO_ReturnsNone()
    {
        ...
        key.MapToInputCommand().Should().Be(InputCommand.None);
    }
    ...
    public void CKey_ReturnsUnacknowledge()
    {
        ...
        key.MapToInputCommand().Should().Be(InputCommand.Unacknowledge);
    }
    ...
    public void SKey_ReturnsSilence()
    {
        ...
        key.MapToInputCommand().Should().Be(InputCommand.Silence);
    }
    ...
    public void QKey_ReturnsQuit()
    {
        ...
        key.MapToInputCommand().Should().Be(InputCommand.Quit);
    }
