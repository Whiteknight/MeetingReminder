...
public class TuiCommandHandlingTests
{
    ...
    public sealed class NavigationTests : TuiCommandHandlingTests
    {
        ...
        public async Task NavigateDown_WithNoSelection_SelectsFirstMeeting()
        {
            ...
            await _tuiService.HandleCommandForTesting(new TuiCommand.NavigateDown(), CancellationToken.None);
        ...
        public async Task NavigateUp_WithNoSelection_SelectsFirstMeeting()
        {
            ...
            await _tuiService.HandleCommandForTesting(new TuiCommand.NavigateUp(), CancellationToken.None);
        ...
        public async Task Navigate_WithNoMeetings_DoesNotThrow()
        {
            await _tuiService.Invoking(s =>
                s.HandleCommandForTesting(new TuiCommand.NavigateDown(), CancellationToken.None))
                .Should().NotThrowAsync();

            await _tuiService.Invoking(s =>
                s.HandleCommandForTesting(new TuiCommand.NavigateUp(), CancellationToken.None))
                .Should().NotThrowAsync();
        }
    }
    ...
    public sealed class AcknowledgeTests : TuiCommandHandlingTests
    {
        ...
        public async Task Acknowledge_WithSelectedMeeting_AcknowledgesMeeting()
        {
            ...
            await _tuiService.HandleCommandForTesting(new TuiCommand.NavigateDown(), CancellationToken.None);
            await _tuiService.HandleCommandForTesting(new TuiCommand.Acknowledge(), CancellationToken.None);
        ...
        {
            await _tuiService.Invoking(s =>
                s.HandleCommandForTesting(new TuiCommand.Acknowledge(), CancellationToken.None))
                .Should().NotThrowAsync();
        }
    }
    ...
    public sealed class OpenAndAcknowledgeTests : TuiCommandHandlingTests
    {
        ...
        public async Task OpenAndAcknowledge_WithLink_OpensLinkAndAcknowledges()
        {
            ...
            await _tuiService.HandleCommandForTesting(new TuiCommand.NavigateDown(), CancellationToken.None);
            await _tuiService.HandleCommandForTesting(new TuiCommand.OpenAndAcknowledge(), CancellationToken.None);
        ...
        {
            await _tuiService.Invoking(s =>
                s.HandleCommandForTesting(new TuiCommand.OpenAndAcknowledge(), CancellationToken.None))
                .Should().NotThrowAsync();
        }
    }
    ...
    public sealed class QuitTests : TuiCommandHandlingTests
    {
        ...
        {
            await _tuiService.HandleCommandForTesting(new TuiCommand.Quit(), CancellationToken.None);
    ...
    public sealed class NoneCommandTests : TuiCommandHandlingTests
    {
        ...
        public async Task None_DoesNotAffectState()
        {
            ...
            await _tuiService.HandleCommandForTesting(new TuiCommand.None(), CancellationToken.None);
